...
All synthetic scenario generation, audit protocol, and meta-model code, together with all reported summary statistics, are publicly available at \url{https://github.com/jesusgilru-prog/audit-protocol-reliability-dce}, tagged release \texttt{v1.6-authors} for a stable, citable snapshot matching the numbers reported in this manuscript. Generated with a fixed random seed (\texttt{RNG\_SEED=20260818}, hardcoded in each generation script and reported in the main summary JSON files) for exact reproducibility. A permanent Zenodo DOI archiving this repository will be minted and added here upon acceptance.
