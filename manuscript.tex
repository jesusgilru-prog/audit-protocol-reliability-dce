...
All synthetic scenario generation, audit protocol, and meta-model code, together with all reported summary statistics, are publicly available at \url{https://github.com/jesusgilru-prog/audit-protocol-reliability-dce}, tagged release \texttt{v1.2-numbers-fix} for a stable, citable snapshot matching the numbers reported in this manuscript. Generated with fixed random seeds (reported in each result file) for exact reproducibility. A permanent Zenodo DOI archiving this repository will be minted and added here upon acceptance.
